        ...
        <img class="img-fluid able-logo" src="../images/logo.png"   ></a>
         <nav class="navbar navbar-static-top">
            ...
            <ul class="top-nav lft-nav">
              ...
              <li class="dropdown">
                  <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                     <span>Coded Gift Items </span><i class=" icofont icofont-simple-down"></i>
                  </a>
                  <ul class="dropdown-menu settings-menu">
                     <li><a href="#">Diamond ->₦5,000.00</a></li>
                     <li><a href="#">Sapphire ->₦4,000.00</a></li>
                     <li><a href="#">Topaz  ->₦3,000.00</a></li>
                     <li><a href="#">Opal ->₦2,000.00</a></li>
                     <li><a href="#">Jasper ->₦1,500.00</a></li>
                  </ul>
               </li>-->
               ...
               <ul class="top-nav">
                  ...
                  <li class="dropdown">
                     <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                        <span><img class="img-circle " src="assets/images/avatar-1.png" style="width:40px;" alt=""></span>
                        <span><b><?php echo $surname;  ?>  </b> <i class=" icofont icofont-simple-down"></i></span>

                     </a>
                     <ul class="dropdown-menu settings-menu">
                        <li><a href="self_event.php"><i class="icon-settings"></i> Setup Event</a></li>
                        <li><a href="account-update.php"><i class="icon-user"></i> Profile</a></li>
