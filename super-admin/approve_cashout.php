...
?> 
  ...
  <div class="container-fluid">
					   ...
					   <div class="row">
                            ...
                            <div class=" col-md-12">
                                <div class="card bg-light text-dark mb-4">
									...
									<h3> 	Unapproved Cashout </h3>
									</div>
									
                                    <div class="card-footer d-flex align-items-center justify-content-between ">
										<ol class="breadcrumb mb-4">
										<li class="breadcrumb-item active" style="text-decoration:underline;"><i> <a href="index.php">Home</a>&nbsp; / &nbsp;Unapproved Cashout</i></li>
										</ol>
				...
				<div class="card mb-4">
					...
					<div style="font-size:22px;"> <i class="fa fa-briefcase mr-1" ></i>UNPAID  CASHOUT PORTFOLIO </div>
				...
				<tbody>
						   ...
						   <?php
							...
							$query_data ="SELECT * FROM `cashout` WHERE `cashout`.`payment_status` = 'Admin_Processing' ";
							...
							while ($row = mysqli_fetch_array($query_data_result)){
								...
								<td>
								<form action='cashout_otp.php' method='POST'>
							    <input type='hidden' name='cashout_code' value='$cashout_code' />  
													
								<button id='BtnSubmit'  class='btn btn-warning'>
								Approve Payment
								</button>
								</form>
   ...
   // alert("Okay");
      ...
      $.ajax({
        ...
        beforeSend:function()
        {
          ...
          $('#user_register').val('<span><img src="../images/spinner.gif />"<span>');
        },
