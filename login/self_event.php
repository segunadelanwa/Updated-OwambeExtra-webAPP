...
function popup(s1,s2){
  ...
  s2.innerHTML = "";
    ...
    if(s1.value == "2"){
   $(s2).html('<div class="alert alert-primary"><a href="gallery.php"><div class="btn btn-info">Select Banner Template</div> </a>  </div>');
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="main-header">
                  <h4> CREATE SELF EVENT</h4>
                
				<div> 
                   <em>
				 
				 <a href="index.php" style="color:#777777 !important;"> Home </a> / <a href="#"> Create Self Event</a>
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="digits" name="contact_no" id="contact_no" class="form-control" /> 
                  </div>
